 ...
 * @author Diego Noble
 */
public class EquivalenciasDialog extends javax.swing.JDialog {

    EquivalenciaUnidadesDAO equivalenciasDAO;

    EquivalenciaUnidades equivalenciaUnidades;
    List<EquivalenciaUnidades> listEquivalencias;
    EquivalenciaUnidadesTableModel tableModel;
    ListSelectionModel listModel;
    Articulo articuloSeleccionado;

    public EquivalenciasDialog(java.awt.Frame parent, boolean modal, Component frame, Articulo articulo) {
        super(parent, modal);
        initComponents();
    ...
    final void configuraTbl() {
        ...
        tbl.getColumn("Unidad").setCellEditor(new ComboBoxCellEditor(new EquivalenciasDialog.ComboBoxUnidades()));
        ...
        tableModel.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent tme) {
                ...
                equivalenciasDAO = new EquivalenciaUnidadesDAO();
                equivalenciasDAO.guardarList(listEquivalencias);
    ...
    void elminarSeleccionado() {
        try {
            EquivalenciaUnidades toDelete = tableModel.getCliente(tbl.getSelectedRow());
            tableModel.eliminar(tbl.getSelectedRow());
            equivalenciasDAO = new EquivalenciaUnidadesDAO(toDelete);
            equivalenciasDAO.elimina();
            btnEliminar.setEnabled(false);
        } catch (Exception e) {
    ...
    private void txtBuscaPropiedadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaPropiedadActionPerformed
        ...
        equivalenciasDAO = new EquivalenciaUnidadesDAO();
        equivalenciasDAO = new EquivalenciaUnidadesDAO();
        listEquivalencias.addAll(equivalenciasDAO.buscarPor(EquivalenciaUnidades.class, "nombre", txtBuscaPropiedad.getText()));
