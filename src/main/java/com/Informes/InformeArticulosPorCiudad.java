 ...
 * @author Diego Noble
 */
public class InformeArticulosPorCiudad extends javax.swing.JDialog {

    CiudadDAO ciudadDAO;
    LeeProperties props = new LeeProperties();

    public InformeArticulosPorCiudad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inicia();
    ...
    public void reporte() {
        ...
        try {
            ...
            InputStream resource = getClass().getClassLoader().getResourceAsStream("informesJasperServer/articulosPorCiudad.jasper");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Articulos por ciudad");
